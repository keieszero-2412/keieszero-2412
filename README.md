...
## Contact Information
- **Email:** keieszero2412@gmail.com
- **LinkedIn:** https://www.linkedin.com/in/khanhtran2412/
...
*International Economics | 09/2024 - 05/2028*
...
**RemoBPO** | *AI Tester*
*04/2026 - 08/2026*
- Evaluated and annotated Large Language Model (LLM) outputs to identify logic errors, hallucinations, and edge cases, contributing to improved model accuracy.
- Provided structured, high-quality feedback and data labeling based on complex project guidelines, ensuring data integrity for AI training.


## Academic & Personal Projects

### 1. ZeroCoder Learning Platform
- **Technologies:** `HTML5`, `CSS3`, `JavaScript`, `Python`, `Firebase`, `Vercel`
- **Description:** An online platform, designed specifically for Foreign Trade University students to review and prepare for their programming course.
